...
const HireMe = () => {
  return (
    <div className="fixed left-1 bottom-2 flex items-center justify-center overflow-hidden md:right-[1em] md:left-auto md:top-[-45.5em] md:botton-auto md:absolute">
